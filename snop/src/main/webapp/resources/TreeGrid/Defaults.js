TreeGridLoaded ({ /* JSONP header, to be possible to load from xxx_Jsonp data source */ 
   ...
   "Cfg" : { 
      ...
      /*
     - PrintPageOrientation  : 0(portrait), 1(landscape)
     - PDFFitPage : 0(Real size), 1(Width), 2(Height), 3(Single page)
      */
      "PrintPageWidth": "643", "PrintPageHeight": "971", "PrintPageSize": "8", "PrintPageOrientation": "1", "PrintDPI": "96", "PrintDefaultDPI": "96", "PrintMinDPI": "96", "PrintMarginWidth": "40", "PrintMarginHeight": "40", "PrintPaddingWidth": "0", "PrintPaddingHeight": "0", "PrintMarginDiv": "1", 
      "ExportPDFCols": "2", "PDFFitPage": "3", "PDFText": "1", "PDFFormat": "pdf", 
      ...
      "SuppressAnimations": "1", "AnimateRows": "3", "AnimateCells": "1", "AnimateCols": "1", "AnimateDialogs": "2", "AnimateRowsMax": "10", "AnimateRowsColorMax": "10", "AnimateColsMax": "10", "AnimateCellsMax": "200", "AnimateUndo": "1", 
      ...
      "Style": "HJ", "GanttStyle": "White", "Size": "Wide", "DefaultSize": "Normal", "Scale": "", "Contrast": "Default",
      /*
     - StyleLap : 1(Style의 값을 쿠키에 저장하지 않음), 0(Style의 값을 쿠키에 저장)
     - SizeLap  : 1(Size의 값을 쿠키에 저장하지 않음), 0(Size의 값을 쿠키에 저장)
     - ScaleLap : 1(Scale의 값을 쿠키에 저장하지 않음), 0(Scale의 값을 쿠키에 저장)
     - PrintPageOrientation  : 0(portrait), 1(landscape)
      */
      "StyleLap": "0", "SizeLap": "0", "ScaleLap": "0", 
      
      "Styles": "{HJ:{Name:'HJ',CSS:'*Styles/HiteJinroGrid.css'},TS:{Name:'Standard',CSS:'*Styles/StandardGrid.css'},TW:{Name:'White',CSS:'*Styles/WhiteGrid.css'},TB:{Name:'Black',CSS:'*Styles/BlackGrid.css'},TM:{Name:'Material',CSS:'*Styles/MaterialGrid.css'},TT:{Name:'Turq',CSS:'*Styles/TurqGrid.css'},CF:{Name:'Relief',CSS:'Compatible/Relief',Compatible:1},CL:{Name:'Light',CSS:'Compatible/Light',Compatible:1},CO:{Name:'Office',CSS:'Compatible/Office',Compatible:1},CG:{Name:'Gradient',CSS:'Compatible/Gradient',Compatible:2},CB:{Name:'Borders',CSS:'Compatible/Borders',Compatible:1},CQ:{Name:'Query',CSS:'Compatible/Query',Compatible:1},CE:{Name:'ExtJS',CSS:'Compatible/ExtJS',Compatible:1},CS:{Name:'Sharp',CSS:'Compatible/Sharp',Compatible:1},CR:{Name:'Round',CSS:'Compatible/Round',Compatible:1},CP:{Name:'Plain',CSS:'Compatible/Plain',Compatible:1},CC:{Name:'Colors',CSS:'Compatible/Colors',Compatible:1}}", 
      ...
      "Scales": "{'50%':0.5,'60%':0.6,'70%':0.7,'75%':0.75,'80%':0.8,'85%':0.85,'90%':0.9,'95%':0.95,'100%':1,'110%':1.1,'125%':1.25,'150%':1.5,'200%':2}", 
      ...
      "Language": "", "SyncLanguage": "1", "UseLanguages": "EN,GB,DE,FR,CA,IT,ES,PT,BR,CS,RU,JP,CN,FA"  
       }, 
   ...
   "Cfg_2" : { 
      ...
      "TextFont": "Nanum Gothic,'Times New Roman',serif", "TextFonts": "|'Microsoft Sans Serif',Tahoma,'Trebuchet MS',sans-serif|<span style=\"font-family:'Microsoft Sans Serif',Tahoma,'Trebuchet MS',sans-serif\">Abcdefghijk1234</span>|'Times New Roman',serif|<span style=\"font-family:'Times New Roman',serif\">Abcdefghijk1234</span>|'Courier New',monospace|<span style=\"font-family:'Courier New',monospace\">Abcdefghijk1234</span>||default", 
      ...
      "Cfg_3" : { 
         "IESvg": ["CustScroll1Right,CustScroll1Left,CustScroll1Down,CustScroll1Up,",
                 "LevelButton,SpaceSelectInner,ButtonClose,PopupLeft,TabHtmlBase PopupLeft,CellImg,",
                 ...
                 "MenuExpandedIcon,MenuCollapsedIcon,MenuNextIcon,TSMenuNextIconRtl,MenuNextIconDown,MenuEnum,MenuEnumHeaderLeft,EnumControl,",
   ...
   "DefCols" : [ 
      ...
      { "Name": "Gantt", "Def": "", "Visible": "1", "Type": "Gantt", "MenuName": "Gantt chart", "CanPrint": "1", 
         "CanSort": "0", "CanEdit": "0", "CanResize": "0", "CanFilter": "0", "CanCopyPaste": "0", "CanGroup": "0", "CanSearch": "0", "CanExport": "0", "WidthPad": "", "ShowHint": "0", "CanDrag": "0", "CanSelect": "0", "CanDelete": "0", "NoUpload": "1", "FormulaCanUse": "0", "CanFix": "0", 
   ...
   // Bottom toolbar 
/* 2021.07.12 ykw Toolbar에서 Scroll, Lock, Contrasts 제거
   "Toolbar" : { "id": "Toolbar", "CanPrint": "0", "Space": "4", "Tag": "", "Visible": "1", "CanHide": "0", "LastVisible": "Lock", 
      ...
      "Cells60Cfg": "Sort,Calc,WinScroll,Columns,Cfg,Lock,Help,Debug", 
...
*/
   "Toolbar" : { "id": "Toolbar", "CanPrint": "0", "Space": "4", "Tag": "", "Visible": "1", "CanHide": "0", "LastVisible": "Lock", 
      ...
      "Cells70Styles": "Languages,Styles,GanttStyles,Sizes,Scales", 
      "LanguagesType": "Languages", "Languages": "2", "LanguagesVisibleFormula": "Grid.Language?1:0", 
      "StylesType": "Styles", "Styles": "2", 
      "GanttStylesType": "GanttStyles", "GanttStyles": "2", 
      "SizesType": "Sizes", "Sizes": "2", 
