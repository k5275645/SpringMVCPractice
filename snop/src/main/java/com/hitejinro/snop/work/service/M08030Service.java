...
import com.hitejinro.snop.work.dao.M08030DaoMapper;
 ...
 */
@Service
public class M08030Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M08030Service.class);

	@Inject
	private M08030DaoMapper m08030DaoMapper;
	...
	public List<Map<String, Object>> search(Map<String, Object> params) throws Exception {
		...
		list = m08030DaoMapper.search(params);
	...
	public Map<String, Object> save(Map<String, Object> params) throws Exception {
		...
		try {
            ...
            // 3. 정합성 체크
            List<Map<String, Object>> arrValidList = m08030DaoMapper.validate(oSaveParam);
            ...
            if(deleteList.size() > 0) {
                iDeleteCnt = m08030DaoMapper.delete(oSaveParam);
            ...
            if(updateList.size() > 0) {
                iUpdateCnt = m08030DaoMapper.update(oSaveParam);
	...
	public List<List<Map<String, Object>>> searchPop(Map<String, Object> params) throws Exception {
		...
		list.add(m08030DaoMapper.searchPop(params));
