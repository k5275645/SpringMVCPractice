...
import com.hitejinro.snop.work.dao.M01040DaoMapper;
 ...
 */
@Service
public class M01040Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M01040Service.class);

	@Inject
	private M01040DaoMapper m01040DaoMapper;
	...
	public Map<String, Object> search(Map<String, Object> params) throws Exception {
		...
		params.put("PIVOT_PARAM", m01040DaoMapper.searchPivotParam(params));

		params.put("TREEGRID_HEADER", m01040DaoMapper.searchHeader(params));
		
		arrData = m01040DaoMapper.searchBody(params);
	...
	public List<Map<String, Object>> getTerritoryCombo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getTerritoryCombo(params);
	...
	public List<Map<String, Object>> getDepartmentCombo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getDepartmentCombo(params);
	...
	public List<Map<String, Object>> getPartCombo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getPartCombo(params);
	...
	public List<Map<String, Object>> getSalesrepCombo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getSalesrepCombo(params);
	...
	public List<Map<String, Object>> getAccountCombo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getAccountCombo(params);
	...
	public List<Map<String, Object>> getSegment2Combo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getSegment2Combo(params);
	...
	public List<Map<String, Object>> getSegment3Combo(Map<String, Object> params) throws Exception {
		...
		result = m01040DaoMapper.getSegment3Combo(params);
