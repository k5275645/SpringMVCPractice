...
import com.hitejinro.snop.work.service.M08120Service;
 ...
 */
@Controller
public class M08120Controller {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M08120Controller.class);

	@Inject
	private M08120Service m08040Service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08120/search", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08120/save", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
