...
import com.hitejinro.snop.work.dao.M08020DaoMapper;
 ...
 */
@Service
public class M08020Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M08020Service.class);

	@Inject
	private M08020DaoMapper m08040DaoMapper;
	...
	public Map<String, Object> save(Map<String, Object> params) throws Exception {
		...
		try {
			...
			if (updateList.size() > 0) {
				iInsertCnt = m08040DaoMapper.insertVersion(params);	//저장전 기존데이터 version백업
