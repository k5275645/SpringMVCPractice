...
import com.hitejinro.snop.work.service.M08020Service;
 ...
 */
@Controller
public class M08020Controller {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M08020Controller.class);

	@Inject
	private M08020Service m08040Service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08020/search", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08020/save", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
