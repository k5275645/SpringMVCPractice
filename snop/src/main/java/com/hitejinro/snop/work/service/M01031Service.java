...
import com.hitejinro.snop.work.dao.M01031DaoMapper;
 ...
 */
@Service
public class M01031Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M01031Service.class);

	@Inject
	private M01031DaoMapper m01031DaoMapper;
	...
	public Map<String, Object> search(Map<String, Object> params) throws Exception {
		...
		params.put("TREEGRID_HEADER", m01031DaoMapper.searchHeader(params));
		
		arrData = m01031DaoMapper.searchBody(params);
	...
	public List<Map<String, Object>> getSegment2Combo(Map<String, Object> params) throws Exception {
		...
		result = m01031DaoMapper.getSegment2Combo(params);
	...
	public List<Map<String, Object>> getSegment3Combo(Map<String, Object> params) throws Exception {
		...
		result = m01031DaoMapper.getSegment3Combo(params);
