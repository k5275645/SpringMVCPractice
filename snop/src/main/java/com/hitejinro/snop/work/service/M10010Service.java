...
import com.hitejinro.snop.work.dao.M10010DaoMapper;
 ...
 */
@Service
public class M10010Service {

    @SuppressWarnings("unused")
    private static final Logger logger = LoggerFactory.getLogger(M10010Service.class);

    @Inject
    private M10010DaoMapper m10010DaoMapper;
    ...
    public List<Map<String, Object>> search(Map<String, Object> params) throws Exception {
        ...
        list = m10010DaoMapper.search(params);
        return list;
    }
    ...
    public List<Map<String, Object>> selectLeafMenuList(Map<String, Object> params) throws Exception {
        return m10010DaoMapper.selectLeafMenuList(params);
    }
    ...
    public Map<String, Object> save(Map<String, Object> params) throws Exception {
        ...
        try {
            ...
            if(deleteList.size() > 0) {
                iDeleteCnt = m10010DaoMapper.delete(oSaveParam);
            ...
            if(updateList.size() > 0) {
                iUpdateCnt = m10010DaoMapper.update(oSaveParam);
