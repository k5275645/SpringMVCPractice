...
import com.hitejinro.snop.work.service.M09020Service;
 ...
 */
@Controller
public class M09020Controller {

    @SuppressWarnings("unused")
    private static final Logger logger = LoggerFactory.getLogger(M09020Controller.class);

    @Inject
    private M09020Service m09020Service;
    ...
    public ModelAndView getView(@RequestParam Map<String, Object> params) throws Exception {
        ...
        if(StringUtils.isEmpty(mSearchOption.get("toYYYYMM"))) {
            List<Map<String, Object>> arrMaxPeriod = m09020Service.selectMaxPeriod(params);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/work/M09020/search", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
    @ResponseBody
    public Map<String, Object> search(@RequestBody Map<String, Object> params) throws Exception {
        ...
        // - 데이터 조회
        mResult = m09020Service.search(params);
