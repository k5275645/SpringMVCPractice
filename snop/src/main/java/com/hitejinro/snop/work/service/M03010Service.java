...
import com.hitejinro.snop.work.dao.M03010DaoMapper;
 ...
 */
@Service
public class M03010Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M03010Service.class);

	@Inject
	private M03010DaoMapper m03010DaoMapper;
	...
	public Map<String, Object> searchPeriod(Map<String, Object> params) throws Exception {
		return m03010DaoMapper.searchPeriod(params);
	}
	...
	public List<Map<String, Object>> searchChart(Map<String, Object> params) throws Exception {
		return m03010DaoMapper.searchChart(params);
	}

	/**
	 * 헤더 조회
	 * @param params {startDate, endDate, liquorCode, acctType} 
	 * @return [{LIQUOR_CODE, LIQUOR_DESC, ORG_TYPE, ROW_NUMBER, HEADER1_DESC, HEADER2_DESC, HEADER3_DESC, HEADER3_SPAN...}]
	 * @throws Exception
	 */
	public List<Map<String, Object>> searchHeader(Map<String, Object> params) throws Exception {
		return m03010DaoMapper.searchHeader(params);
	}
	...
	public List<Map<String, Object>> search(Map<String, Object> params) throws Exception {
		return m03010DaoMapper.search(params);
	}
}
