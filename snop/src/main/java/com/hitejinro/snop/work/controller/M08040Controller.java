...
import com.hitejinro.snop.work.service.M08040Service;
 ...
 */
@Controller
public class M08040Controller {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M08040Controller.class);

	@Inject
	private M08040Service m08040Service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08040/search", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/work/M08040/save", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
