...
import com.hitejinro.snop.work.dao.M03020DaoMapper;
 ...
 */
@Service
public class M03020Service {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(M03020Service.class);

	@Inject
	private M03020DaoMapper m03020DaoMapper;
	...
	public List<Map<String, Object>> searchHeader(Map<String, Object> params) throws Exception {
		return m03020DaoMapper.searchHeader(params);
	}
	...
	public List<Map<String, Object>> search(Map<String, Object> params) throws Exception {
		return m03020DaoMapper.search(params);
	}
}
